...
def registro_admin():
    ...
    if request.method == 'POST':
        ...
        page = doc[0]
        # Insertar el número de serie en las coordenadas (120.02, 193.88) con font-size 6.
        page.insert_text((120.02, 193.88), numero_serie, fontsize=6, fontname="helv", color=(0, 0, 0))
